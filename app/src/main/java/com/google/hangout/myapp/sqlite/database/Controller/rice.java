    ...
    public void init(){
        ...
        but1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent t123= new Intent(rice.this,lunch_time.class);
                startActivity(t123);
        ...
        simpleSwitch.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked) {
                            Toast.makeText(rice.this,"Switch On", Toast.LENGTH_SHORT).show();
                            //init();
                            but1 = (Button)findViewById(R.id.button1);
                            but1.setOnClickListener(new View.OnClickListener(){
                                ...
                                public void onClick(View view){
                                    ...
                                    Intent t123= new Intent(rice.this,OrderDetails.class);
                                    t123.putExtra(quantity1,quantity12);
                                    t123.putExtra(type1,"Rice and Curry");
                            ...
                            but1.setOnClickListener(new View.OnClickListener(){
                                ...
                                @Override
                                public void onClick(View view){
                                    Toast.makeText(rice.this,"Please add to bag", Toast.LENGTH_SHORT).show();
