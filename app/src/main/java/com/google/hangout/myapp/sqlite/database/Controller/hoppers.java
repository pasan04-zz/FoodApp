    ...
    public void init(){
        ...
        but1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent t123= new Intent(hoppers.this,dinner_time.class);
                startActivity(t123);
        ...
        simpleSwitch.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked) {
                            Toast.makeText(hoppers.this,"Switch On", Toast.LENGTH_SHORT).show();
                            //init();
                            but1 = (Button)findViewById(R.id.button1);
                            but1.setOnClickListener(new View.OnClickListener(){
                                ...
                                public void onClick(View view){
                                    ...
                                    Intent t123= new Intent(hoppers.this,OrderDetails.class);
                                    t123.putExtra(quantity1,quantity12);
                                    t123.putExtra(type1,"Hoppers");
                            ...
                            but1.setOnClickListener(new View.OnClickListener(){
                                ...
                                @Override
                                public void onClick(View view){
                                    Toast.makeText(hoppers.this,"Please add to bag", Toast.LENGTH_SHORT).show();
