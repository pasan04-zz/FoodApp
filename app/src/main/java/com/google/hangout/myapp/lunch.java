    ...
    public void init(){
        ...
        but1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent b1 = new Intent(lunch.this,rice.class);
                String number = elegantNumberButton.getNumber();
                double elenumber = Double.parseDouble(number);
                if(elenumber==0 ){

                    Toast.makeText(lunch.this,"Quantity must be greater than zero",Toast.LENGTH_SHORT).show();
                }
                else if(elenumber>10){
                    Toast.makeText(lunch.this,"Not sufficient storage to supply your order",Toast.LENGTH_SHORT).show();
                }

                else{

                    TextView txtView = (TextView) findViewById(R.id.ricePrice);
        ...
        but2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent b2 = new Intent(lunch.this,FriedRice.class);
                ...
                if(elenumber==0 ){
                    ...
                    TextView txtView = (TextView) findViewById(R.id.friedricePrice);
                    double d1 = Double.parseDouble(txtView.getText().toString());
                    final double salesTaxPerItem = d1 * 10.0 / 100.0;
                    double salesTax  = salesTaxPerItem*elenumber;
                    String qty = String.valueOf(elenumber);
        ...
        but3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent b3 = new Intent(lunch.this,noodles.class);
        ...
        but4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Intent b4 = new Intent(lunch.this,biriyani.class);
                ...
                if(elenumber==0 ){
                    ...
                    TextView txtView = (TextView) findViewById(R.id.biriyaniPrice);
                    double d1 = Double.parseDouble(txtView.getText().toString());
                    final double salesTaxPerItem = d1 * 10.0 / 100.0;
                    double salesTax  = salesTaxPerItem*elenumber;
                    String qty = String.valueOf(elenumber);
